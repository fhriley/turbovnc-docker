...
if __name__ == '__main__':
    ...
    parser.add_argument('turbojpeg_branch', help='the branch/tag to build')
    parser.add_argument('turbovnc_branch', help='the branch/tag to build')
    parser.add_argument('tag', nargs='+', help='a tag to add to the image')
    args = parser.parse_args()

    build_args = [
        f'BASE_IMAGE={args.base}',
        f'TURBOJPEG_BRANCH={args.turbojpeg_branch}',
        f'TURBOVNC_BRANCH={args.turbovnc_branch}',
    ]
